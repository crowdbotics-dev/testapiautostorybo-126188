...
## Project Structure
    ...
    ├── testapiautostorybo_126188  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_126188`
...
2. Clone this repo and `cd testapiautostorybo_126188`
